...
ModelCC supports the following options for specifying relative positions:
%
\begin{itemize}
...
\item \an{Position.EXTREME}, puts the element after and/or before the referred element.
...
\item \an{Position.AROUND}, puts the element after, before, and/or in any position of the referred repetition construct.
\end{itemize}
...
public class Program implements{\emph IModel} \{
  ...
  {\bf @Position(element="functions",position=Position.AROUND)}
