...
public class KeyWrapperTest {
    ...
    public void keyWrapperTest1() {
        ...
        CharData a4 = getCharData('4',m,map,true);
        CharData a1b = getCharData('1',m,map,true);
        CharData a2b = getCharData('2',m,map,true);
        CharData a3b = getCharData('3',m,map,true);
        CharData a4b = getCharData('4',m,map,true);
    ...
    public void keyWrapperTestEquals1() {
        ...
        CharData a4 = getCharData('4',m,map,false);
        CharData a1b = getCharData('1',m,map,false);
        CharData a2b = getCharData('2',m,map,false);
        CharData a3b = getCharData('3',m,map,false);
        CharData a4b = getCharData('4',m,map,false);
