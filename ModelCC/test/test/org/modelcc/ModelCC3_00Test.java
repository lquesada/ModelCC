...
public class ModelCC3_00Test {
    ...
    public void ModelCCTest1() {
        ...
        try {
            ...
            Logger.getLogger(ModelCC3_00Test.class.getName()).log(Level.SEVERE, null, ex);
            assertFalse(true);
            return;
        }
    ...
    public void ModelCCTest2() {
        ...
        try {
            ...
            Parser<Expression> parser = ProbabilisticParserFactory.create(m,lexer);
